...
- 用户输入用户名密码登录系统，无账号自动注册，数据存储在vercel提供的云端数据库Neon中
- 每个用户拥有独立的个人药箱和用药计划。

### 3.2 药品信息查询
- 首页展示常用药品列表（已审核录入150+常见药，如布洛芬、阿莫西林、维生素C等）。
...
- 已录入至少150+条常见症状-疾病对应关系（医学生可提供真实数据，例如“咳嗽、咳痰、发热”对应“急性支气管炎”等）。
